                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <?php } ?>
                                <td><?php echo htmlspecialchars($row1['startingDate']); ?></td>
                                <td><?php echo htmlspecialchars($row1['finalDate']); ?></td>
        ...
        <h2 class="card-title text-white m-3">Ordered Items:</h2>
            <div class="card bg-primary-subtle">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php
                        $sql = "SELECT b.*, c.* FROM bookings b JOIN carsforsale c ON b.item_id = c.id WHERE b.order_id = $orderId";
                        $result1 = mysqli_query($link, $sql);
                        $amountLeft = 0;
                        while($row1 = mysqli_fetch_assoc($result1)){
                            $amountLeft = $row1['carPrice']-$row1['deposit'];
                            ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($row1['carName']); ?></td>
                                    <td><img src="image/<?php echo htmlspecialchars($row1['photo']); ?>" alt="Car photo" style="width:300px"></td>
                                    <td><?php echo htmlspecialchars($row1['carYear']); ?></td>
                                    <td><?php echo htmlspecialchars($row1['carStatus']); ?></td>
                                    <td>$<?php echo htmlspecialchars($row1['carPrice']); ?></td>
                                    <td>$<?php echo htmlspecialchars($row1['deposit']); ?></td>
                                    <td><?php echo htmlspecialchars($row1['bookingDate']); ?></td>
                                </tr>
                            <?php
                        }
                        ?>
                ...
                <h5 class="text-end">Total Rent Fee: $<?php echo htmlspecialchars($amountLeft); ?></h5>
            </div>
        <?php }; ?>
</div>
</div>
