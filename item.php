<?php
    ...
    $sql = "SELECT r.*, c.* FROM reviews r JOIN clients c ON r.user_id = c.id WHERE item_id = {$_GET['id']}";
    $result = mysqli_query($link, $sql);
    
    echo "<div class='d-flex flex-wrap justify-content-between align-items-center mt-5'>
            <h2>Reviews</h2>
            <a href='addReview.php?id={$_GET['id']}' class='btn btn-primary fs-5'>Add a New Review</a>
          </div>";
