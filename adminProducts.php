...
echo "<p class='text-center mb-5'><a href='addProduct.php?status=sale' class='btn btn-primary fs-4'>ADD A NEW PRODUCT</a></p>";
if(mysqli_num_rows($result)>0) {
  echo "<h1 class='text-center text-dark'> For Sale Cars In Stock </h1>";
